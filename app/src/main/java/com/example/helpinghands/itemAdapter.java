...
public class itemAdapter extends RecyclerView.Adapter<itemAdapter.Holder> {
    ...
    private int calculateAverage(List<Integer> ratings) {
        ...
        return (int) Math.round(average); // Round to the nearest whole number
    }
    ...
    public static class Holder extends RecyclerView.ViewHolder {
        ...
        RatingBar ratingBar; // Add this line
        ...
        public Holder(@NonNull View itemView) {
            ...
            ratingBarParent = itemView.findViewById(R.id.ratingBarParent);
        }
    }
